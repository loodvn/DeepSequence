...
export msa_path=/n/groups/marks/users/lood/DeepSequence_runs/pascal_deepseq_alignments_dir
export model_checkpoint_dir=/n/groups/marks/users/lood/DeepSequence_runs/params_tmp_seed/
